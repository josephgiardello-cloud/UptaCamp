...
def draw_settings_modal(
    *,
    ...
    screen.blit(voice_style_label, (modal.x + 28, modal.y + 430))
    settings_voice_style_rect = pygame.Rect(modal.x + 216, modal.y + 426, 196, 44)
    ...
    screen.blit(backend_label, (modal.x + 28, modal.y + 482))
    settings_voice_backend_rect = pygame.Rect(modal.x + 216, modal.y + 478, 196, 44)
    ...
    screen.blit(rvc_label, (modal.x + 28, modal.y + 534))
    settings_rvc_toggle_rect = pygame.Rect(modal.x + 216, modal.y + 530, 196, 44)
    ...
    screen.blit(pitch_label, (modal.x + 28, modal.y + 586))
    settings_rvc_pitch_left_rect = pygame.Rect(modal.x + 216, modal.y + 582, 46, 44)
    settings_rvc_pitch_right_rect = pygame.Rect(modal.x + 366, modal.y + 582, 46, 44)
    pitch_mid_rect = pygame.Rect(modal.x + 272, modal.y + 582, 84, 44)
    ...
    settings_voice_test_rect = pygame.Rect(modal.x + 116, modal.y + 636, 248, 44)
    ...
    screen.blit(local_exe_label, (field_left_x, modal.y + 694))
    settings_local_exe_rect = pygame.Rect(field_left_x, modal.y + 720, field_col_w, 30)
    ...
    screen.blit(local_model_label, (field_right_x, modal.y + 694))
    settings_local_model_rect = pygame.Rect(field_right_x, modal.y + 720, field_col_w, 30)
    ...
    screen.blit(rvc_exe_label, (field_left_x, modal.y + 762))
    settings_rvc_exe_rect = pygame.Rect(field_left_x, modal.y + 788, field_col_w, 30)
    ...
    screen.blit(rvc_model_label, (field_right_x, modal.y + 762))
    settings_rvc_model_rect = pygame.Rect(field_right_x, modal.y + 788, field_col_w, 30)
    ...
    screen.blit(rvc_index_label, (field_left_x, modal.y + 804))
    settings_rvc_index_rect = pygame.Rect(field_left_x, modal.y + 830, field_col_w, 30)
    ...
    if warn_text:
        ...
        screen.blit(warn, (modal.x + 28, modal.y + 862))
